          ...
          <div class="col-md-6 col-xl-3">
               <div class="card">
                    <div class="card-body text-center">
                         ...
                         <h4 class="mt-3 mb-0">Categories</h4>
                    </div>
               </div>
          </div>
          <div class="col-md-6 col-xl-3">
               <div class="card">
                    <div class="card-body text-center">
                         ...
                         <h4 class="mt-3 mb-0">Total Categories</h4>
                    </div>
               </div>
          </div>
          ...
          <div class="col-xl-12">
               <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center gap-1">
                         ...
                         <a href="<?= BASE_URL . 'index.php?action=add-category' ?>" class="btn btn-sm btn-primary">
                              Add Category
                         </a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <p class="text-dark fw-medium fs-15 mb-0"><?= htmlspecialchars($category['category_name']) ?></p>
                                                        </div>
                                                    </td>
                                                    <td><?= htmlspecialchars($category['description']) ?></td>
                                                    <td>
                                                        <div class="d-flex gap-2">
                                                            <a href="index.php?action=show-category&id_cate=<?= $category['category_id'] ?>" class="btn btn-light btn-sm">
                                                                <iconify-icon icon="solar:eye-broken" class="align-middle fs-18"></iconify-icon>
                                                            </a>
                                                            <a href="<?= BASE_URL . 'index.php?action=edit-category&id_cate=' . $category['category_id'] ?>" class="btn btn-soft-primary btn-sm">
                                                                <iconify-icon icon="solar:pen-2-broken" class="align-middle fs-18"></iconify-icon>
                                                            </a>
                                                            <a href="<?= BASE_URL . 'index.php?action=delete-category&id_cate=' . $category['category_id'] ?>" class="btn btn-soft-danger btn-sm" onclick="return confirm('Bạn có chắc chắn muốn xóa?')">
