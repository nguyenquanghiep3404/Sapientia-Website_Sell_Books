               ...
               <div class="col-xl-3 col-lg-4">
                    <div class="card">
                              ...
                              <div class="mt-3">
                                   ...
                                   <div class="row">
                                        ...
                                        <div class="col-lg-6 col-6">
                                             ...
                                             <h5 class="mb-0"><?= htmlspecialchars($publisher['publisher_id'] ?? '') ?></h5>
                                        </div>
                                   </div>
                              </div>
                         </div>
                         <div class="card-footer border-top">
                              <div class="row g-2">
                                   <div class="col-lg-6">
                                        <button type="submit" form="editPublisherForm" class="btn btn-primary w-100">
               ...
               <div class="col-xl-9 col-lg-8">
                    ...
                    <?php else : ?>
                         <div class="card">
                              ...
                              <div class="card-body">
                                   <form action="?action=postedit-publisher" method="POST" id="editPublisherForm">
                                             ...
                                             <div class="col-lg-12">
                                                  <div class="mb-3">
                                                       ...
                                                       <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control <?= isset($errors['publisher_name']) ? 'is-invalid' : '' ?>" 
                                                                   id="publisher_name" name="publisher_name" 
                                                                   value="<?= htmlspecialchars($publisher['publisher_name']) ?>" required>
                                                       </div>
                                                       <?php if (isset($errors['publisher_name'])) : ?>
                                                            <div class="invalid-feedback d-block"><?= htmlspecialchars($errors['publisher_name']) ?></div>
                                                       <?php endif; ?>
                                                  </div>
                                             </div>
                                             <div class="col-lg-12">
