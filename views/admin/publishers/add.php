...
<div class="container mt-4">
    ...
    <form action="?act=postAdd&type=publisher" method="POST">

        <div class="mb-3">
            <label for="publisher_name" class="form-label">Tên Nhà xuất bản</label>
            <input type="text" name="publisher_name" id="publisher_name" class="form-control" value="<?= isset($_POST['publisher_name']) ? htmlspecialchars($_POST['publisher_name']) : '' ?>">
