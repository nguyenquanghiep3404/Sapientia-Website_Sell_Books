    ...
    <div class="container-fluid py-4">
        <div class="card border-0 shadow">
            <div class="card-header bg-danger text-white">
                <h2 class="card-title mb-0"><i class='bx bxs-group me-2'></i> Quản Lý Tài Khoản</h2>
            </div>
            <div class="card-body">
                    ...
                    <table class="table table-hover align-middle">
                        ...
                        <tbody>
                            ...
                            <tr class="animate__animated animate__fadeIn">
                                ...
                                <td class="password-cell"><?= substr($registers['password'], 0, 10) ?>...</td>
                                <td><?= $registers['phone'] ?></td>
                                <td><?= $registers['address'] ?></td>
                                <td>
                                    <form action="?action=update_role" method="post" class="d-inline">
                                        ...
                                        <select name="role_id" class="form-select form-select-sm" onchange="this.form.submit()">
                                            ...
                                            <option value="1" <?= $registers['role_id'] == 1 ? 'selected' : '' ?>>Khách hàng</option>
                                        </select>
                                    </form>
                                </td>
                                <td>
                                    <div class="d-flex gap-2">
                                        <a href="?action=editUser&id=<?= $registers['user_id'] ?>" class="btn btn-sm btn-warning">
                                            <i class='bx bx-edit-alt'></i> Sửa
                                        </a>
                                        <a href="?action=delete&id=<?= $registers['user_id'] ?>" 
