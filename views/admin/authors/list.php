               ...
               <div class="col-md-6 col-xl-3">
                    <div class="card">
                         <div class="card-body text-center">
                              ...
                              <h4 class="mt-3 mb-0">Total Authors</h4>
                         </div>
                    </div>
               </div>
               ...
               <div class="col-xl-12">
                    <div class="card">
                         <div class="card-header d-flex justify-content-between align-items-center gap-1">
                              <h4 class="card-title flex-grow-1">All Authors List</h4>

                              <a href="?action=add-author" class="btn btn-sm btn-primary">
                                   Add Author
                              </a>
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td>
                                                                 <div class="d-flex align-items-center gap-2">
                                                                      ...
                                                                      <p class="text-dark fw-medium fs-15 mb-0"><?= htmlspecialchars($author['author_name']) ?></p>
                                                                 </div>
                                                            </td>
                                                            <td><?= nl2br(htmlspecialchars($author['bio'])) ?></td>
                                                            <td>
                                                                 <div class="d-flex gap-2">
                                                                      <a href="index.php?action=show-author&id_author=<?= $author['author_id'] ?>" class="btn btn-light btn-sm">
                                                                           <iconify-icon icon="solar:eye-broken" class="align-middle fs-18"></iconify-icon>
                                                                      </a>
                                                                      <a href="<?= BASE_URL . 'index.php?action=edit-author&id_author=' . $author['author_id'] ?>" class="btn btn-soft-primary btn-sm">
                                                                           <iconify-icon icon="solar:pen-2-broken" class="align-middle fs-18"></iconify-icon>
                                                                      </a>
                                                                      <a href="<?= BASE_URL . 'index.php?action=delete-author&id_author=' . $author['author_id'] ?>" class="btn btn-soft-danger btn-sm" onclick="return confirm('Bạn có chắc chắn muốn xóa?')">
