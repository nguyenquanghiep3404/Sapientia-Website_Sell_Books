            ...
            <div class="product_container row">
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="all" role="tabpanel">
                        ...
                        <?php foreach($listBookWithVariants as $book):  ?>
                                ...
                                <figure>
                                    <div class="product_thumb">
                                        <a href="product-details.html">
                                            <img class="primary_img" src="<?= htmlspecialchars($book['book_image']) ?>"
                                                alt="consectetur" width="150">
                                        </a>
                                        <!-- Để nguyên -->
                                    ...
                                    <div class="product_content text-center">
                                        ...
                                        <h4 class="product_name"><a href="product-details.html"><?= htmlspecialchars($book['book_title']) ?></a></h4>                                        </h4>
                                        <div class="price_box">
                                            <span class="current_price"><?= number_format($book['variant_sale_price'] )  ?></span>
                                            <span class="old_price"><?= number_format($book['variant_price'] )  ?></span>
                                        </div>
                        ...
                        <div class="product_slick slick_slider_activation" data-slick='{
                            ...
                            <article class="col single_product">
                                <figure>
                                    <div class="product_thumb">
                                        <a href="product-details.html">
                                            <img class="primary_img" src="public/client/assets_client/img/product/product3.jpg"
                                                alt="consectetur">
                                        </a>
                                        <div class="product_action">
                                            <ul>
                            ...
                            <article class="col single_product">
                                <figure>
                                    <div class="product_thumb">
                                        <a href="product-details.html">
                                            <img class="primary_img" src="public/client/assets_client/img/product/product4.jpg"
                                                alt="consectetur">
                                        </a>
                                        <div class="product_action">
                                            <ul>
                            ...
                            <article class="col single_product">
                                <figure>
                                    <div class="product_thumb">
                                        <a href="product-details.html">
                                            <img class="primary_img" src="public/client/assets_client/img/product/product1.jpg"
                                                alt="consectetur">
                                        </a>
                                        <div class="product_action">
                                            <ul>
                            ...
                            <article class="col single_product">
                                <figure>
                                    <div class="product_thumb">
                                        <a href="product-details.html">
                                            <img class="primary_img" src="public/client/assets_client/img/product/product2.jpg"
                                                alt="consectetur">
                                        </a>
                                        <div class="product_action">
                                            <ul>
        ...
        <div class="container">
            ...
            <div class="banner_container d-flex">
                <figure class="single_banner position-relative mr-30 ">
                    <img src="public/client/assets_client/img/bg/bg1.jpg" alt="">
                ...
                <figure class="single_banner position-relative">
                    <img src="public/client/assets_client/img/bg/bg2.jpg" alt="">
                    <figcaption class="banner_text position-absolute">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <figure class="single_banner position-relative">
                        <img src="public/client/assets_client/img/bg/bg3.jpg" alt="">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <figure class="single_banner position-relative">
                        <img src="public/client/assets_client/img/bg/bg4.jpg" alt="">
            ...
            <div class="blog_container row">
                <div class="blog_slick slick_slider_activation" data-slick='{
                    ...
                    <article class="col single_blog">
                        <figure>
                            <div class="blog_thumb">
                                <a href="blog-details.html"><img src="public/client/assets_client/img/blog/blog1.jpg" alt=""></a>
                            </div>
                    ...
                    <article class="col single_blog">
                        <figure>
                            <div class="blog_thumb">
                                <a href="blog-details.html"><img src="public/client/assets_client/img/blog/blog2.jpg" alt=""></a>
                            </div>
                            <figcaption class="blog_content">
                                <div class="blog_meta">
                                    <ul class="d-flex">
                    ...
                    <article class="col single_blog">
                        <figure>
                            <div class="blog_thumb">
                                <a href="blog-details.html"><img src="public/client/assets_client/img/blog/blog3.jpg" alt=""></a>
                            </div>
                            <figcaption class="blog_content">
                                <div class="blog_meta">
                                    <ul class="d-flex">
