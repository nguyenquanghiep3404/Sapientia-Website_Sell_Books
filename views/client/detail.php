...
<head>
    ...
    <!-- CSS
    ========================= -->
    <link rel="stylesheet" href="public/client/assets_client/css/vendor/bootstrap.min.css">
    <link rel="stylesheet" href="public/client/assets_client/css/slick.css">
    <link rel="stylesheet" href="public/client/assets_client/css/simple-line-icons.css">
    <link rel="stylesheet" href="public/client/assets_client/css/ionicons.min.css">
    <link rel="stylesheet" href="public/client/assets_client/css/font.awesome.css">
    <link rel="stylesheet" href="public/client/assets_client/css/animate.css">
    <link rel="stylesheet" href="public/client/assets_client/css/nice-select.css">
    <link rel="stylesheet" href="public/client/assets_client/css/jquery-ui.min.css">
    <link rel="stylesheet" href="public/client/assets_client/css/magnific-popup.css">

    <!-- Main Style CSS -->
    <link rel="stylesheet" href="public/client/assets_client/css/style.css">

    <!--modernizr min js here-->
    <script src="public/client/assets_client/js/vendor/modernizr-3.7.1.min.js"></script>
...
<body>
    ...
    <div class="mini_cart">
        <div class="cart_gallery">
            ...
            <div class="cart_item">
               <div class="cart_img">
                   <a href="#"><img src="public/client/assets_client/img/product/product1.jpg" alt=""></a>
               </div>
                <div class="cart_info">
            ...
            <div class="cart_item">
               <div class="cart_img">
                   <a href="#"><img src="public/client/assets_client/img/product/product2.jpg" alt=""></a>
               </div>
                <div class="cart_info">
                    ...
                    <div class="col-12">
                        <div class="header_container d-flex justify-content-between align-items-center">
                            ...
                            <div class="header_logo">
                                <a class="sticky_none" href="index.html"><img src="public/client/assets_client/img/logo/logo.png" alt=""></a>
                            </div>
                            <!--main menu start-->
                    ...
                    <div class="product_zoom_gallery">
                       <div class="zoom_gallery_inner d-flex">
                           <div class="zoom_tab_img">
                                <a class="zoom_tabimg_list" href="javascript:void(0)"><img src="public/client/assets_client/img/product/small-product/product1.png" alt="tab-thumb"></a>
                                <a class="zoom_tabimg_list" href="javascript:void(0)"><img src="public/client/assets_client/img/product/small-product/product2.png" alt="tab-thumb"></a>
                                <a class="zoom_tabimg_list" href="javascript:void(0)"><img src="public/client/assets_client/img/product/small-product/product3.png" alt="tab-thumb"></a>
                                <a class="zoom_tabimg_list" href="javascript:void(0)"><img src="public/client/assets_client/img/product/small-product/product4.png" alt="tab-thumb"></a>
                                <a class="zoom_tabimg_list" href="javascript:void(0)"><img src="public/client/assets_client/img/product/small-product/product1.png" alt="tab-thumb"></a>
                                <a class="zoom_tabimg_list" href="javascript:void(0)"><img src="public/client/assets_client/img/product/small-product/product2.png" alt="tab-thumb"></a>
                                <a class="zoom_tabimg_list" href="javascript:void(0)"><img src="public/client/assets_client/img/product/small-product/product3.png" alt="tab-thumb"></a>
                                <a class="zoom_tabimg_list" href="javascript:void(0)"><img src="public/client/assets_client/img/product/small-product/product4.png" alt="tab-thumb"></a>
                           ...
                           <div class="product_zoom_main_img">
                                <div class="product_zoom_thumb">
                                    <img data-image="public/client/assets_client/img/product/big-product/product1.png" src="public/client/assets_client/img/product/big-product/product1.png" alt="">
                                </div>
                                <div class="product_zoom_thumb">
                                    <img data-image="public/client/assets_client/img/product/big-product/product1.png" src="public/client/assets_client/img/product/big-product/product1.png" alt="">
                                </div>
                                ...
                                <div class="reviews_wrapper">
                                    ...
                                    <div class="reviews_comment_box">
                                        <div class="comment_thmb">
                                            <img src="public/client/assets_client/img/blog/comment2.jpg" alt="">
                                        </div>
                            ...
                            <figure>
                                <div class="product_thumb">
                                    <a href="product-details.html" >
                                        <img class="primary_img" src="public/client/assets_client/img/product/product1.jpg" alt="consectetur">
                                    </a>
                    ...
                    <div class="col-lg-3">
                        <article class="single_product">
                            <figure>
                                <div class="product_thumb">
                                    <a href="product-details.html" >
                                        <img class="primary_img" src="public/client/assets_client/img/product/product2.jpg" alt="consectetur">
                                    </a>
                                    <div class="product_action">
                                        <ul>
                                            <li class="wishlist"><a href="#" data-tippy="Wishlist" data-tippy-inertia="true" data-tippy-delay="50"
                    ...
                    <div class="col-lg-3">
                        <article class="single_product">
                            <figure>
                                <div class="product_thumb">
                                    <a href="product-details.html" >
                                        <img class="primary_img" src="public/client/assets_client/img/product/product3.jpg" alt="consectetur">
                                    </a>
                                    <div class="product_action">
                                        <ul>
                                            <li class="wishlist"><a href="#" data-tippy="Wishlist" data-tippy-inertia="true" data-tippy-delay="50"
                    ...
                    <div class="col-lg-3">
                        <article class="single_product">
                            <figure>
                                <div class="product_thumb">
                                    <a href="product-details.html" >
                                        <img class="primary_img" src="public/client/assets_client/img/product/product4.jpg" alt="consectetur">
                                    </a>
                                    <div class="product_action">
                                        <ul>
                                            <li class="wishlist"><a href="#" data-tippy="Wishlist" data-tippy-inertia="true" data-tippy-delay="50"
                ...
                <div class="col-lg-5 col-md-5 col-sm-5">
                    <div class="footer_widget_list">
                        <div class="footer_logo">
                            <a href="#"><img src="public/client/assets_client/img/logo/logo.png" ></a>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="modal_zoom_gallery">
                                   <div class="product_zoom_thumb">
                                        <img src="public/client/assets_client/img/product/big-product/product1.png" alt="">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12">
...
<script src="public/client/assets_client/js/vendor/jquery-3.4.1.min.js"></script>
<script src="public/client/assets_client/js/vendor/popper.js"></script>
<script src="public/client/assets_client/js/vendor/bootstrap.min.js"></script>
<script src="public/client/assets_client/js/slick.min.js"></script>
<script src="public/client/assets_client/js/wow.min.js"></script>
<script src="public/client/assets_client/js/jquery.scrollup.min.js"></script>
<script src="public/client/assets_client/js/images-loaded.min.js"></script>
<script src="public/client/assets_client/js/isotope.pkgd.min.js"></script>
<script src="public/client/assets_client/js/jquery.nice-select.js"></script>
<script src="public/client/assets_client/js/tippy-bundle.umd.js"></script>
<script src="public/client/assets_client/js/jquery-ui.min.js"></script>
<script src="public/client/assets_client/js/jquery.instagramFeed.min.js"></script>
<script src="public/client/assets_client/js/jquery.magnific-popup.min.js"></script>
<script src="public/client/assets_client/js/mailchimp-ajax.js"></script>


<!-- Main JS -->
<script src="public/client/assets_client/js/main.js"></script>
