...
>>>>>>> 3ad0cc9aeae8d93919bbb77586ae837cb535a931
                    ...
                    <div class="col-12">
                        <div class="header_container d-flex justify-content-between align-items-center">
                            ...
                            <div class="header_logo">
                                <a class="sticky_none" href="index.html"><img src="public/client/assets_client/img/logo/logo.png" width="86px" ></a>
                            </div>
                            <!--main menu start-->
...
=======
    ...
    <section class="slider_section mb-63">
        <div class="slider_area slick_slider_activation" data-slick='{
            ...
            <div class="single_slider d-flex align-items-center" data-bgimg="public/client/assets_client/img/slider/slider1.jpg">
                <div class="container">
                    <div class="row">
            ...
            <div class="single_slider d-flex align-items-center" data-bgimg="public/client/assets_client/img/slider/slider2.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 col-md-7">
                            <div class="slider_text">
            ...
            <div class="single_slider d-flex align-items-center" data-bgimg="public/client/assets_client/img/slider/slider3.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 col-md-7">
                            <div class="slider_text">
