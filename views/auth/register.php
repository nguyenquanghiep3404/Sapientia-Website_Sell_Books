...
<!-- Mirrored from techzaa.in/larkon/admin/auth-signup.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 27 Mar 2025 08:26:49 GMT -->
<head>
     <!-- Title Meta -->
     <meta charset="utf-8" />
                         ...
                         <div class="row justify-content-center h-100">
                              <div class="col-lg-6 py-lg-5">
                                   <div class="d-flex flex-column h-100 justify-content-center">
                                        ...
                                        <p class="text-muted mt-1 mb-4">Chào mừng đến với nền tảng của chúng tôi!</p>

                                        <div>
                                             <form method="POST" action="?action=register_post" class="authentication-form">
                                                  <div class="mb-3">
                                             ...
                                             <p class="mt-3 fw-semibold no-span">Hoặc đăng ký bằng</p>
                                        ...
                                        <p class="mt-auto text-center">Đã có tài khoản?  
                                            <a href="?action=login" class="text-primary fw-bold ms-1">Đăng nhập ngay</a>
                                        </p>
                                   </div>
                              </div>
                         </div>
